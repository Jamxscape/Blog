...
## [常用快捷键](#1.1)	[mac时钟不同步](#1.2)	[ssh免密登录配置出现port 22:Connection refused](#1.3)	[终端或者DOS打开网址](#1.4)	[Mac上加密文件](#1.5)	[安装Macports](#1.6)	[没有修改/usr/bin和/usr/sbin文件夹权限](#1.7)	[Mac版本欧路字典破解](#1.8)
...
1. 安装完成后 打开以下路径 `/user/your_username/lib/preferences/com.eudb.plist` 这个文件
